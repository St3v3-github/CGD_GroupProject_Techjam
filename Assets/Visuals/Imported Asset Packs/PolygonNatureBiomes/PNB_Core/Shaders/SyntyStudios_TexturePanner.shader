	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord7 = IN.ase_texcoord8.xy * appendResult15 + appendResult18;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult15 = (float2(_TilingX , _TilingY));
				float2 appendResult18 = (float2(_OffsetX , _OffsetY));
				float2 texCoord7 = IN.ase_texcoord4.xy * appendResult15 + appendResult18;
				float2 panner6 = ( 1.0 * _Time.y * appendResult21 + texCoord7);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult15 = (float2(_TilingX , _TilingY));
				float2 appendResult18 = (float2(_OffsetX , _OffsetY));
				float2 texCoord7 = IN.ase_texcoord2.xy * appendResult15 + appendResult18;
				float2 panner6 = ( 1.0 * _Time.y * appendResult21 + texCoord7);
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 appendResult15 = (float2(_TilingX , _TilingY));
				float2 appendResult18 = (float2(_OffsetX , _OffsetY));
				float2 texCoord7 = IN.ase_texcoord5.xy * appendResult15 + appendResult18;
				float2 panner6 = ( 1.0 * _Time.y * appendResult21 + texCoord7);
...
ASEEND*/
//CHKSM=DF8F8C606E7E6756EE85FDA8E8EF7E395E9539EA